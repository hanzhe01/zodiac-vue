<template>
  <div class="app-container">
    <!-- <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px" v-if="true">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['constellation:constellation:remove']"></el-button>
      </el-col> -->
      <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="constellationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="网址" align="left" prop="webUrl">
        <template #default="scope">
          <el-link type="success" :href="scope.row.webUrl" target="_blank"><span>{{ scope.row.webUrl }}</span></el-link>
        </template>
      </el-table-column>
...
import { listConstellation, getConstellation, delConstellation, addConstellation, updateConstellation, getPreviewDetails } from "@/api/constellation/constellation";
